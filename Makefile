...
generated/cloud.el: header.el 0.el goodies/macros.el goodies/functions.el goodies/file-functions.el goodies/logging.el 1.el 2.el generated/main.el
	echo ";; -*- mode: Emacs-Lisp;  lexical-binding: t; -*-" >  $@
	cat header.el 0.el goodies/macros.el goodies/functions.el goodies/file-functions.el goodies/logging.el 1.el 2.el generated/main.el >> $@
	echo "(provide 'cloud)" >> $@
