...
#+BEGIN_SRC emacs-lisp :tangle generated/variables.el :shebang ";; -*- lexical-binding: t; -*-"
...
#+BEGIN_SRC emacs-lisp :tangle generated/tests/macro.el :shebang ";; -*- lexical-binding: t; -*-"
...
(first-run
 (ert-deftest cloud-init()
   "just check that config file is created during the first run"
  (cloud-init)
  (should (get-file-properties (concat emacs-d "cloud/" localhost "/config")))))
#+END_SRC
